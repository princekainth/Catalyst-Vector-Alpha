...
class ToolRegistry:
    ...
    def _initialize_default_tools(self) -> None:
        ...
        tools_to_register: List[Tool] = [
            ...
            Tool("generate_report_pdf", "Create a multi-section PDF report.", GENERATE_REPORT_PDF_PARAMS, _tf("generate_report_pdf_tool"),
                 validator=lambda a: bool(a.get("sections")) and isinstance(a["sections"], list),
